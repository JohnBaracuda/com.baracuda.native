...
namespace Baracuda.DOTS.Entities
{
    ...
    public abstract class AutoAuthoringBase : MonoBehaviour
    {
        ...
        [BakeDerivedTypes]
        private class Baker : Baker<AutoAuthoringBase>
        {
        ...
        where TComponentData : new()
    {
        ...
        private static int _EntityFieldCount = -1;
        ...
        private static int ComputeEntityFieldCount()
        {
    ...
    /// </summary>
    /// <typeparam name="TComponentData">
    ///     The ECS component, which must be unmanaged and implement <see cref="IComponentData" />
    ///     .
    /// </typeparam>
    ...
    /// <summary>
    ///     Provides a default baker and support for Entity references for a <see cref="IComponentData" /> ECS managed
    ///     component.
    /// </summary>
    /// <typeparam name="TComponentData">
    ///     The ECS component, which must be a <b>class</b> and implement
    ...
    /// </summary>
    /// <typeparam name="TComponentData">
    ///     The ECS buffer element type, which must be unmanaged and implement
    ///     <see cref="IBufferElementData" />.
    /// </typeparam>
    ...
    /// </summary>
    /// <typeparam name="TComponentData">
    ///     The ECS component, which must be unmanaged and implement
    ///     <see cref="ISharedComponentData" />.
    /// </typeparam>
    ...
    /// <summary>
    ///     Provides a default baker and support for Entity references for a <see cref="ISharedComponentData" /> ECS managed
    ///     component.
    /// </summary>
    /// <typeparam name="TComponentData">
    ///     The ECS component, which must be a <b>struct</b> and implement
    ///     <see cref="ISharedComponentData" />.
    /// </typeparam>
